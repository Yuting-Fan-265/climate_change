...
```{python}
#| label: fig-plot8
#| fig-cap: " of Natural Bridges National Monument(NBNM) <br> Data Source: US Geological Survey (USGS)"  
#| warning: false 
#| echo: false
#| message: false
...
fig8.add_trace(
    go.Scatter(x=list(data2.year),
               y=[data2.PPT_Winter.mean()] * len(data1.index),
               name="Yearly Average",
               #visible=False,
               line=dict(color="#38A7BB", dash="dash")))
...
fig8.add_trace(
    go.Scatter(x=list(data2.year),
               y=[data2.PPT_Summer.mean()] * len(data1.index),
               name="Yearly Average",
               #visible=False,
               line=dict(color="#38A7BB", dash="dash")))
